    ...
    <>
      <nav className="relative justify-between p-2 md:p-5 bg-ij-container-bg border-ij-container-border border-b-2">
        <div className="flex flex-row max-w-[1280px] gap-4 m-auto items-center p-2">
          ...
          <div className={`absolute border-b-2 border-ij-container-border md:border-0 p-4 gap-4 md:relative md:translate-x-0 top-full left-0 transition-all duration-300 ${isToggled ? "translate-x-0" : "-translate-x-full"} flex flex-col md:flex-row md:p-0 bg-white w-full z-10`}>
            <NavBarItem href={'/'}>
              Buscar empleo
            </NavBarItem>
      ...
      <div className="w-full text-center bg-yellow-500 p-2 text-white font-bold">
        La extraccíon de información puede no funcionar. Lo sentimos por los problemas ocasionados.
      </div>
    </>
  )
}